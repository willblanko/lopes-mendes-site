  ...
  return (
    <>
      ...
      <main>
        ...
        {/* Imagem full-width — fade in */}
        <RevealSection threshold={0.01} style={{ position: "relative", width: "100%", height: "520px", overflow: "hidden", display: "block" }}>
          <Image
          ...
          <div style={{ maxWidth: "1200px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px" }} className="sobre-hist-grid">
            ...
            <RevealSection from="right" delay={100}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0" }}>
                {timeline.map((item, i) => (
                  <div key={i} style={{ display: "flex", gap: "24px", paddingBottom: i < timeline.length - 1 ? "28px" : "0" }}>
                    <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                      ...
                      {i < timeline.length - 1 && <div style={{ width: "2px", flex: 1, background: "linear-gradient(180deg, #01A8DD 0%, rgba(1,168,221,0.1) 100%)", marginTop: "4px" }} />}
                    </div>
                    <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "2px" }} className="valores-grid">
              {values.map((v, i) => (
                <RevealSection key={i} delay={i * 100}>
                  <div style={{ backgroundColor: "#003567", padding: "40px 36px", position: "relative", overflow: "hidden", height: "100%" }}>
        ...
        <section style={{ backgroundColor: "#ffffff", padding: "96px 80px" }} className="sobre-premios">
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            <RevealSection style={{ marginBottom: "56px" }}>
              <p className="gradient-text" style={{ fontSize: "11px", fontWeight: 700, letterSpacing: "3px", textTransform: "uppercase", marginBottom: "16px" }}>
                Reconhecimento
              </p>
              <h2 style={{ fontSize: "36px", fontWeight: 300, color: "#003567", lineHeight: 1.2, margin: 0 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "24px" }} className="premios-grid">
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <RevealSection key={i} delay={(i - 1) * 70}>
                  <div style={{ border: "1px solid #e9ecf5", borderRadius: "4px", padding: "32px", display: "flex", flexDirection: "column", gap: "12px", backgroundColor: "#f7f8fa" }}>
            ...
            <RevealSection style={{ marginTop: "40px", textAlign: "center" }}>
